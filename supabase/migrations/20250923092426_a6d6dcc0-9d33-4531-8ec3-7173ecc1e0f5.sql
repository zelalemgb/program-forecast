...
CREATE TABLE public.inventory_transactions (
  ...
  facility_id UUID, -- Changed to UUID to match facilities table
  product_id UUID, -- Changed to UUID to match products table  
...
CREATE TABLE public.inventory_balances (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  facility_id UUID, -- Changed to UUID
  product_id UUID, -- Changed to UUID
...
-- Add missing user_facility_memberships table if it doesn't exist
